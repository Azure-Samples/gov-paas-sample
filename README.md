...
>[!Note]
> You can either press the "Deploy to Azure Government" button below in order to automatically provision all of your resources, or create your resources manually through the Azure Government portal. 
>
>
